...
* DST-aware London and New York timezones — auto-switches GMT+0 / GMT+1
...
Three range families — ADR (14-day default), AWR (4-week default), AMR (6-month default) — each with:
...
**ADR / AWR / AMR**
* Show, 50% levels, metric type, lookback length, color, style, extend — per range family
